            ...
            <div class="layui-form layui-form-pane">
              <form method="post">
                ...
                <div class="layui-form-item">
                  ...
                  <div class="layui-input-inline">
                    <input type="text" name="nickname" v-model="nickname" v-validate="'required|min:4'" autocomplete="off" placeholder="请输入昵称" class="layui-input" />
                  </div>
                </div>
                <div class="error-item">
                  <span class="error">{{
                ...
                <div class="layui-form-item">
                  ...
                  <div class="layui-input-inline">
                    <input type="password" name="c_password" v-model="c_password" v-validate="'required|min:6'" placeholder="请输入确认密码" autocomplete="off" class="layui-input" />
                  </div>
                </div>
                <div class="error-item">
                  <span class="error">{{
